...
This package contains utility modules for querying, filtering, and processing event data from the penguin database.
...
This database is generated by penguin's event collection pipeline and contains all event data for querying.
