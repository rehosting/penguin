...
|`file_offset`|integer|`null`|File offset (integer)|
|`hex_bytes`|string or null|`null`|Bytes to write (hex string)|
|`asm`|string or null|`null`|Assembly code to write (runs through keystone)|
|`mode`|string or null|`null`|Assembly mode|
## `plugins` Plugins
...
|Field|Type|Default|Description|
|-|-|-|-|
|`mac`|string or null|`'52:54:00:12:34:56'`|MAC Address for external interface|
|`pcap`|boolean or null|`null`|pcap file name|
