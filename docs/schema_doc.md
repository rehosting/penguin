...
| -------------------------------------- | ---------------- | --------------------------------------------- |
| - [blocked_signals](#blocked_signals ) | array of integer | Blocked Signals                               |
| + [core](#core )                       | object           | Core configuration options for this rehosting |
| + [env](#env )                         | object           | Environment variables to set in the guest     |
| + [lib_inject](#lib_inject )           | object           | Library functions to be intercepted           |
| - [netdevs](#netdevs )                 | array of string  | Netdevs                                       |
...
| ----------------------------------------------- | ----------- |
| [blocked_signals items](#blocked_signals_items) | -           |

### <a name="autogenerated_heading_2"></a>Penguin Configuration > blocked_signals > blocked_signals items
...
**Description:** Core configuration options for this rehosting
...
| + [fs](#core_fs )                   | string           | Project-relative path to filesystem tarball   |
...
| + [qcow](#core_qcow )               | string           | Project-relative path to filesystem qcow file |
| - [root_shell](#core_root_shell )   | boolean          | Enable root shell                             |
| - [shared_dir](#core_shared_dir )   | Combination      | Project-relative path of shared directory     |
...
**Description:** Library functions to be intercepted

| Property                          | Type        | Title/Description                                          |
| --------------------------------- | ----------- | ---------------------------------------------------------- |
| - [aliases](#lib_inject_aliases ) | Combination | Function names to alias to existing library function shims |
| - [extra](#lib_inject_extra )     | Combination | Extra injected library code                                |

### <a name="lib_inject_aliases"></a>Property `Penguin Configuration > lib_inject > aliases`
...
| Any of(Option)                                   |
| ------------------------------------------------ |
| [LibInjectAliases](#lib_inject_aliases_anyOf_i0) |
| [item 1](#lib_inject_aliases_anyOf_i1)           |

#### <a name="lib_inject_aliases_anyOf_i0"></a>Property `Penguin Configuration > lib_inject > aliases > anyOf > LibInjectAliases`

|                           |                                                                                                                                       |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                                              |
| **Required**              | No                                                                                                                                    |
| **Additional properties** | [[Should-conform]](#lib_inject_aliases_anyOf_i0_additionalProperties "Each additional property must conform to the following schema") |
...
| Property                                                 | Type   | Title/Description |
| -------------------------------------------------------- | ------ | ----------------- |
| - [](#lib_inject_aliases_anyOf_i0_additionalProperties ) | string | -                 |

##### <a name="lib_inject_aliases_anyOf_i0_additionalProperties"></a>Property `Penguin Configuration > lib_inject > aliases > anyOf > Injected library aliases > additionalProperties`
...
#### <a name="lib_inject_aliases_anyOf_i1"></a>Property `Penguin Configuration > lib_inject > aliases > anyOf > item 1`
...
### <a name="lib_inject_extra"></a>Property `Penguin Configuration > lib_inject > extra`
...
| Any of(Option)                       |
| ------------------------------------ |
| [item 0](#lib_inject_extra_anyOf_i0) |
| [item 1](#lib_inject_extra_anyOf_i1) |

#### <a name="lib_inject_extra_anyOf_i0"></a>Property `Penguin Configuration > lib_inject > extra > anyOf > item 0`
...
#### <a name="lib_inject_extra_anyOf_i1"></a>Property `Penguin Configuration > lib_inject > extra > anyOf > item 1`
...
| Each item of this array must be | Description |
| ------------------------------- | ----------- |
| [netdevs items](#netdevs_items) | -           |

### <a name="autogenerated_heading_3"></a>Penguin Configuration > netdevs > netdevs items
