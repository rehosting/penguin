...
from pengutils.utils.cli_syscalls import syscall_filter
...
class Verifier(Plugin):
    ...
    def test_file_not_contains(self, name, test_case):
        return not self.test_file_contains(name, test_case)
