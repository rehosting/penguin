...
ARG PANDA_VERSION="1.8.51"
ARG BUSYBOX_VERSION="0.0.6"
ARG LINUX_VERSION="2.4.7"
ARG LIBNVRAM_VERSION="0.0.15"
ARG CONSOLE_VERSION="1.0.4"
ARG PENGUIN_PLUGINS_VERSION="1.5.14"
ARG VPN_VERSION="1.0.14"
...
ARG VHOST_DEVICE_VERSION="vhost-device-vsock-v0.1.0"
