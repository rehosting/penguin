...
#if defined(CONFIG_X86_64) || defined(__x86_64__) || defined(CONFIG_I386) || (defined(__i386__) && !defined(__x86_64__))
#include <sys/syscall.h>
#include <unistd.h>

static inline void igloo_enable_iopl(void) {
    static int enabled;
    if (!enabled) {
        syscall(SYS_iopl, 3);
        enabled = 1;
...
#define PREPARE_HYPERCALL() igloo_enable_iopl()
#else
#define PREPARE_HYPERCALL() do {} while (0)
#endif
